        ...
        return __generator(this, function (_f) {
            switch (_f.label) {
                ...
                case 7:
                    ...
                    return [4 /*yield*/, processImages(images1, mainDocument, zip, createOptions.indentXml)];
                case 8:
                    _f.sent();
                    return [4 /*yield*/, processLinks(links1, mainDocument, zip, createOptions.indentXml)];
                case 9:
                    _f.sent();
                    return [4 /*yield*/, processHtmls(htmls1, mainDocument, zip, createOptions.indentXml)];
                case 10:
                    _f.sent();
                ...
                case 12:
                    ...
                    return [4 /*yield*/, processImages(images2, documentComponent, zip, createOptions.indentXml)];
                case 13:
                    _f.sent();
                    return [4 /*yield*/, processLinks(links2, mainDocument, zip, createOptions.indentXml)];
                case 14:
                    _f.sent();
                    return [4 /*yield*/, processHtmls(htmls2, mainDocument, zip, createOptions.indentXml)];
                case 15:
                    _f.sent();
                    _f.label = 16;
                case 16:
                ...
                case 17:
                    ...
                    return [4 /*yield*/, (0, zip_1.zipSave)(zip, createOptions.compressionLevel)];
                case 18:
                    output = _f.sent();
...
var processImages = function (images, documentComponent, zip, indentXml) { return __awaiter(void 0, void 0, void 0, function () {
...
var processLinks = function (links, documentComponent, zip, indentXml) { return __awaiter(void 0, void 0, void 0, function () {
...
var processHtmls = function (htmls, documentComponent, zip, indentXml) { return __awaiter(void 0, void 0, void 0, function () {
