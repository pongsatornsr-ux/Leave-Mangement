...
export default function HRPage() {
    ...
    (async () => {
      ...
      try {
        ...
        if (results[0].status === 'fulfilled') {
            ...
            // ✅ 4. ถอดรหัส sickReason ก่อนนำไปแสดงผล
  ...
  // 2. Logic หาปีทั้งหมดที่มีในข้อมูล
  ...
  const groupedLeaves = useMemo(() => {
        ...
        return groups;
  }, [leaves, filterType, selectedYear]);
  ...
  const handleRowClick = (leave) => {
    if (leave.type === 'vacation' || leave.sourceTable === 'vacation') {
        navigate(`/hr/vacationleaves/${leave.id}`); 
    } else {
        navigate(`/hr/personalleaves/${leave.id}`);
    }
  };
                                                ...
                                                return (
                                                    ...
                                                    >
                                                        ...
                                                        <div className="detail-group">
                                                            ...
                                                            {/* แสดงเหตุผล (ที่ถูก Decrypt แล้ว) */}
